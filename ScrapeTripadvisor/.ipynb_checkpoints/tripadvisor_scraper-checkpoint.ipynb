 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    page_response  = requests.post(url =\n",
    "url_from_autocomplete,data=form_data,headers = headers, cookies =\n",
    "cookies, verify=False)\n",
    "    print (\"Parsing results\")\n",
    "    parser = html.fromstring(page_response.text)\n",
    "    hotel_lists = parser.xpath('//div[contains(@class,\"listItem\")]//div[contains(@class,\"listingcollapsed\")]')\n",
    "    hotel_data = []\n",
    "    if not hotel_lists:\n",
